    ...
    public static class EventTypeMap
    {
        ...
        static EventTypeMap()
        {
            s_methodNameEventTypeDictionary = new Dictionary<string, Type>()
            {
                ...
                { "HeadlessExperimental.mainFrameReadyForScreenshots", typeof(HeadlessExperimental.MainFrameReadyForScreenshotsEvent) },
            ...
            s_eventTypeMethodNameDictionary = new Dictionary<Type, string>()
            {
                ...
                { typeof(HeadlessExperimental.MainFrameReadyForScreenshotsEvent), "HeadlessExperimental.mainFrameReadyForScreenshots" },
