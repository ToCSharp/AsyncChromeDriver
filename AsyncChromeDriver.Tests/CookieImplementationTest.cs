...
namespace OpenQA.Selenium
{
    ...
    public class CookieImplementationTest : DriverTestFixture
    {
        ...
        public async Task GetCookiesInAFrame()
        {
           ...
           await driver.GoToUrl(EnvironmentManager.Instance.UrlBuilder.WhereIs("frameWithAnimals.html");
            AssertCookieIsNotPresentWithName(cookie1.Name);
        ...
        {
           await driver.GoToUrl(this.isOnAlternativeHostName ? EnvironmentManager.Instance.UrlBuilder.WhereElseIs(pageName) : EnvironmentManager.Instance.UrlBuilder.WhereIs(pageName);
        }

        private async Task GoToOtherPage(String pageName)
        {
           await driver.GoToUrl(this.isOnAlternativeHostName ? EnvironmentManager.Instance.UrlBuilder.WhereIs(pageName) : EnvironmentManager.Instance.UrlBuilder.WhereElseIs(pageName);
        }
